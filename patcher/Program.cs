    ...
    class Program
    {
        ...
        private static void CheckArgs(string[] args)
        {
            if (args.Length == 0 || args[0] == "/?" || args[0] == "help" || args[0] == "?" || args.Length == 1)
            {
                ...
                Console.WriteLine("  example #1 (without mask):");
                Console.WriteLine("    mycrack.txt");
                Console.WriteLine("    1B 80 90 90 E6");
                Console.WriteLine("    1B 90 90 90 90");
                Console.WriteLine("  example #2 (with search pattern mask):");
                Console.WriteLine("    mycrack.txt");
                Console.WriteLine("    1B 80 90 ?? E6");
                Console.WriteLine("    1B 90 90 90 90");
                Console.WriteLine("  example #3 (with replace pattern mask):");
                Console.WriteLine("    mycrack.txt");
                Console.WriteLine("    1B 80 90 90 E6");
